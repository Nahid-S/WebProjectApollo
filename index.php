<link rel="icon" type="image/ico" href="../logoa.ico">
<?php 
session_start();
        ...
        <div class="admin-left" id="slideNav">
          ...
          <div class="tab">
            ...
            <div class="tablinks" onclick="openCity(event, 'media')">
              ...
              <span class="tooltip">Emergency Info</span>
...
<!-- left section start -->
              ...
              <div class="header-right-inner-right">
                ...
                <div id="admin_details" class="admin_details">
                   ...
                   <div class="admin_message_section">
                       <div style='width:50%;border:1px solid #000;' class="admin_message_section_left">
                         <div class="admin_message_chat">
                         <i class="fas fa-comments"></i>
                              <p style="font-size: 17px;letter-spacing:4px;">Message</p>
                         </div>
                       </div>
                       <div style='width:50%;border:1px solid #000;'  class="admin_message_section_right">
      ...
      <!-- parents section end ========================== -->
          <div id="schedule" class="tabcontent">
            <h3>Resicence Info</h3>
            <p>Where you can find a room Near DIU</p>
            <?php include 'assets/ress.php'; ?>
          </div>
          ...
          <div id="media" class="tabcontent">
            ...
            <?php include 'assets/emergency.php'; ?>
          </div>
