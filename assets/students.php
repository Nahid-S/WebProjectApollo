              ...
              <div class="student_tabcontent_data">
                ...
                <form enctype="multipart/form-data" id="student_formData" >
                    ...
                    <div class="first_last_name">
                      ...
                      <span class="l_right">
                        <label for="s_lname">Price</label>
                        <input type="text" id="s_lname" name="l_name" required />
                        <br />
                      </span>
                    </div>
                    <label for="s_father">Shop Name</label>
                    <input type="text" id="s_father" name="s_father" required />
                    <br />
                    <label for="s_enroll_year">Traits</label>
                    <input
                      type="text"
                      id="s_enroll_year"
                      name="s_enroll_year"
                    ...
                    <div class="s_class">
                      <span class="s_class_left">
                        <label for="s_dob">Additional</label>
                    ...
                    <label for="s_gender">Availability</label>
                    ...
                    <br />
                    <label for="s_academic_year">Extra</label>
                    <input
                      type="text"
                      id="s_academic_year"
